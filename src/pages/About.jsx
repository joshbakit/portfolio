  ...
  return (
    <div className='container mx-auto min-h-screen items-center'>
      ...
      <div className='flex flex-col gap-4 p-8'>
          ...
          <div className='skills_context'>
            <div className="tech_stack flex justify-center p-2 md:p-6 lg:p-8 gap-8 flex-wrap ">
              ...
              <div className="video_and_design w-64 h-64 flex flex-col justify-center border-2 border-gray-200 rounded-full bg-slate-200 bg-opacity-10 p-4 items-center text-center">
                <h2 className='text-2xl font-bold'>Video and Design</h2>
                <ul>
                  <li>PS PHOTOSHOP</li>
                  <li>FIGMA</li>
        ...
        <div className="education mt-8 px-10 py-6 rounded-md shadow-md shadow-slate-800">
          ...
          <div className='edu p-8 flex flex-col gap-4'>
            <div className='flex justify-between'>
              <div>
                <h1 className='text-xl font-bold'>Bachelor of Science in Information and Technology</h1>
                <p>Access Computer College</p>
              </div>
              <h1 className='text-xl font-bold'>2017</h1>
            </div>
            <div className='flex justify-between'>
              <div>
                <h1 className='text-xl font-bold'>Computer Programming and Hardware Servicing NCII</h1>
            ...
            <div className='flex justify-between'>
              <div>
                <h1 className='text-xl font-bold'>MERN Stack Course</h1>
            ...
            <div className='flex justify-between'>
              <div>
                <h1 className='text-xl font-bold'>C# .NET CORE API with MS SQL Course</h1>
                <p>Udemy Online Course</p>
              </div>
              <h1 className='text-xl font-bold'>2024</h1>
            </div>
